...
global {
	...
	shape_file roads_shape_file <- shape_file("../../includes/FinRod5.shp");
	...
	init {
		...
		create vehicle number: 15 with: (location: one_of(intersection).location);
	}
...
species vehicle skills: [driving] {
	...
	aspect base {
		draw triangle(15.0) color: color rotate: heading + 90 border: #black;
	}
}
